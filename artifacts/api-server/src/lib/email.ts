...
export async function sendCollectionConfirmedEmail(booking: Booking): Promise<void> {
  const pickupDate = new Date(booking.pickupDate + "T00:00:00").toLocaleDateString("en-AU", {
    weekday: "long",
    year: "numeric",
    month: "long",
...
Great news — your kids' items have been collected! 🎉

We picked up your ${booking.tierName} collection on ${pickupDate}. Every item will be sorted by hand and given a second life — whether that's through resale, donation, or repurposing. Nothing goes to landfill.

Thank you for making a difference for families across the Mornington Peninsula.
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
        ...
        <tr>
          <td style="padding:40px 40px 24px;text-align:center;">
            ...
            <h1 style="margin:0 0 8px;font-size:26px;font-weight:700;color:#1a2e1a;">Your items have been collected, ${firstName}!</h1>
            <p style="margin:0;font-size:16px;color:#4a6741;">We picked up your <strong>${booking.tierName}</strong> collection on <strong>${pickupDate}</strong>.</p>
          </td>
        </tr>
        <tr>
          <td style="padding:0 40px 32px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f7f4;border-radius:10px;padding:24px;">
              <tr><td>
                <p style="margin:0 0 12px;font-size:15px;color:#333;line-height:1.6;">
                  Every item will be sorted by hand and given a second life — whether that's through resale, donation, or repurposing. <strong>Nothing goes to landfill.</strong>
                </p>
                <p style="margin:0 0 12px;font-size:15px;color:#333;line-height:1.6;">
                  Thank you for making a difference for families across the Mornington Peninsula. 💚
                </p>
...
`;
  ...
  await sendEmail({
    to: booking.email,
    subject: `Your items have been collected! 🎉 | Second Life Kids`,
    text,
    html,
  });
}
